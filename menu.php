    ...
    <section class="bg-light" id="portfolio">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-sm-6 col-md-4 portfolio-item">
                    <a class="portfolio-link" href="#" disabled>
                        <div class="portfolio-hover">
                            <div class="portfolio-hover-content"><i class="fa fa-plus fa-3x"></i></div>
                        </div><img class="img-fluid" src="assets/img/portfolio/1-fulll.jpg">
                    </a>
                    <div class="portfolio-caption">
                        <h4>Nivel 2</h4>
                    </div>
                ...
                <div class="col-sm-6 col-md-4 portfolio-item">
                    <a class="portfolio-link" href="#" disabled>
                        <div class="portfolio-hover">
                            <div class="portfolio-hover-content"><i class="fa fa-plus fa-3x"></i></div>
                        </div><img class="img-fluid" src="assets/img/portfolio/2-fulll.jpg">
                    </a>
                    <div class="portfolio-caption">
                        <h4>Nivel 3</h4>
                    </div>
                ...
                <div class="col-sm-6 col-md-4 portfolio-item">
                    <a class="portfolio-link" href="#">
                        <div class="portfolio-hover">
                            <div class="portfolio-hover-content"><i class="fa fa-plus fa-3x"></i></div>
                        </div><img class="img-fluid" src="assets/img/portfolio/5-full.jpeg">
                    </a>
                    <div class="portfolio-caption">
                        <h4>Instrucciones</h4>
                    </div>
                ...
                <div class="col-sm-6 col-md-4 portfolio-item">
                    <a class="portfolio-link" href="#">
                        <div class="portfolio-hover">
                            <div class="portfolio-hover-content"><i class="fa fa-plus fa-3x"></i></div>
                        </div><img class="img-fluid" src="assets/img/portfolio/5-thumbnail.png">
                    </a>
                    <div class="portfolio-caption">
                ...
                <div class="col-sm-6 col-md-4 portfolio-item">
                    <a class="portfolio-link" href="#">
                        <div class="portfolio-hover">
                            <div class="portfolio-hover-content"><i class="fa fa-plus fa-3x"></i></div>
                        </div><img class="img-fluid" src="assets/img/portfolio/6-thumbnaill.jpg">
                    </a>
                    <div class="portfolio-caption">
                        <h4>Más...</h4>
                    </div>
